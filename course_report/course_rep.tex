...
open-source software written in Erlang\cite{erlang_proglang} (including Erlang/OTP itself) is hosted
...
use plain Makefiles and are not releasable since they are not proper OTP\cite{erlnag_otp}
